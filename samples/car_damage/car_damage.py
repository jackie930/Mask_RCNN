...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 car_damage.py train --dataset=/path/to/car_damage/dataset --weights=imagenet
...
DEFAULT_LOGS_DIR = os.path.join(ROOT_DIR, "car_damage_logs")
...
class CarDamageConfig(Config):
    """Configuration for training on the car damage inspectation dataset.
    ...
    NUM_CLASSES = 1 + 1  # Background + cardamage (to add)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect car damages.')
    ...
    parser.add_argument('--logs', required=False,
                        ...
                        help='Logs and checkpoints directory (default=car_damage_logs/)')
